...
//        File f = new File("/home/nick/dumps/ledger-full-120000.json");
    ...
    @Test
    public void testSerializedPaymentTransactionFromString() {
        String tx_json = "{\"Account\":\"rQhRpcXJ7gEH45c6aK1faqZaTxfj28aei9\",\"Amount\":\"1000000\",\"Destination\":\"rshBYF3tBD5Sy76yr7izy7ePSwB6t6zi8e\",\"Fee\":\"30\",\"Sequence\":4,\"Signers\":[{\"Signer\":{\"Account\":\"rHZBYLuyK8UjZi3ZzGxRBehQhkkaqEFQeH\",\"SigningPubKey\":\"03F4B50B1D51A1EBA90A0FAF0ABF7EF1E37E21FC3371C773D2EC55731151A39371\",\"TxnSignature\":\"3045022100989AE18EA2BED73E6C98E219D858A23FEA5DE0DC1B8EA1E9FF281DFD812D37B5022053E077CD577160FA0E86F563D7F5E28DAE16F9F335264110F2080B85FE997C5E\"}}],\"SigningPubKey\":\"\",\"TransactionType\":\"Payment\",\"hash\":\"02866C9642C34EADFE17707CC841D6118127941EAAFE8D67F0AACDB16CC32FA2\"}}";

        Payment payment = (Payment) Payment.fromJSON(tx_json);
        STArray signers = payment.get(STArray.Signers);
        if (signers == null) {
            signers = new STArray();
            payment.put(STArray.Signers, signers);
        }
        AccountID newAccount = AccountID.fromAddress("r3mxzQYs8QXo1V6aDeyZCZhnbJjN6Av5xj");
        STObject signer = new STObject();
        signer.put(AccountID.Account, newAccount);
        signer.putTranslated(Blob.SigningPubKey, "02573BA92DBA33B4EDA8E1289E888D70F1916142D487F906214096A4EA15200195");
        signer.putTranslated(Blob.TxnSignature, "304402201214116D021E810B3D7F8859851F0513435B39115DA74EF108321218C595AEE3022015BC9BF37A7042FAC05664D488D38A457A342A9998FF50AF23FA327605B1F809");
        ...
        String expected = "C69CC510C0715397E2BEF68805B1D1A1D2CE4B1215C817513987024A58DAB666";
        String hash = Index.transactionID(payment.toBytes()).toHex();
        assertEquals(expected, hash);
        payment.remove(Field.hash);
        payment.putTranslated(Field.hash, hash);
        System.out.println(payment.toJSON());

        String expectedSerialization = "";
        assertEquals(expectedSerialization, payment.toHex());
    }
    ...
    @Test
    public void testSignerListSetFromJson() {
        SignerListSet signerListSet = (SignerListSet) SignerListSet.fromJSON("{\"Flags\":0,\"TransactionType\":\"SignerListSet\",\"Account\":\"rBFu8pLV6A5aBKCnWBhtwhU41nkCJuipSb\",\"Fee\":\"10\",\"Sequence\":2,\"SignerQuorum\":2,\"SignerEntries\":[{\"SignerEntry\":{\"Account\":\"rp56SnJqpMewghc6vsPG8VV3j6bBMTB137\",\"SignerWeight\":1}},{\"SignerEntry\":{\"Account\":\"rMyDRZouY2a4S2k4e6afhjYhYU1PUaYwhJ\",\"SignerWeight\":1}},{\"SignerEntry\":{\"Account\":\"rG1qWLeht6NesFEpw29riiwoJoJpHwJF8F\",\"SignerWeight\":1}}]}");
        assertEquals(2, signerListSet.signerQuorum().longValue());
        assertEquals("rBFu8pLV6A5aBKCnWBhtwhU41nkCJuipSb", signerListSet.account().address);
        assertEquals(0.00001, signerListSet.fee().doubleValue(), 0.000001);
        assertEquals(2, signerListSet.sequence().doubleValue(), 0.000001);
        assertEquals(3, signerListSet.signerEntries().size());
        signerListSet.sign("sh1dsKRu11erYKS5zH7F3HNgFLxey");
    }

    @Test
    public void testMultiSign1() throws Exception {
        String tx_json = "{\"Account\":\"rQhRpcXJ7gEH45c6aK1faqZaTxfj28aei9\",\"Amount\":\"1000000\",\"Destination\":\"rshBYF3tBD5Sy76yr7izy7ePSwB6t6zi8e\",\"Fee\":\"30\",\"Sequence\":4,\"TransactionType\":\"Payment\"}";

        Payment payment = (Payment) Payment.fromJSON(tx_json);
        SignedTransaction signedTransaction = payment.signFor("rHZBYLuyK8UjZi3ZzGxRBehQhkkaqEFQeH", "ssDnkh5Gbfp5ELmAMzzEKAobXgbYG");
        System.out.println(signedTransaction.txn.toJSON());
        assertEquals("02866C9642C34EADFE17707CC841D6118127941EAAFE8D67F0AACDB16CC32FA2", signedTransaction.hash.toHex());
    }

    @Test
    public void testMultiSign2() throws Exception {
        String tx_json = "{\"Account\":\"rQhRpcXJ7gEH45c6aK1faqZaTxfj28aei9\",\"Amount\":\"1000000\",\"Destination\":\"rshBYF3tBD5Sy76yr7izy7ePSwB6t6zi8e\",\"Fee\":\"30\",\"Sequence\":4,\"Signers\":[{\"Signer\":{\"Account\":\"rHZBYLuyK8UjZi3ZzGxRBehQhkkaqEFQeH\",\"SigningPubKey\":\"03F4B50B1D51A1EBA90A0FAF0ABF7EF1E37E21FC3371C773D2EC55731151A39371\",\"TxnSignature\":\"3045022100989AE18EA2BED73E6C98E219D858A23FEA5DE0DC1B8EA1E9FF281DFD812D37B5022053E077CD577160FA0E86F563D7F5E28DAE16F9F335264110F2080B85FE997C5E\"}}],\"SigningPubKey\":\"\",\"TransactionType\":\"Payment\",\"hash\":\"02866C9642C34EADFE17707CC841D6118127941EAAFE8D67F0AACDB16CC32FA2\"}";

        Payment payment = (Payment) Payment.fromJSON(tx_json);
        SignedTransaction signedTransaction = payment.signFor("r3mxzQYs8QXo1V6aDeyZCZhnbJjN6Av5xj", "shCvWNR3iQvi1RomzUwkgJBAMTTx5");
        System.out.println(signedTransaction.txn.toJSON());
        assertEquals("C69CC510C0715397E2BEF68805B1D1A1D2CE4B1215C817513987024A58DAB666", signedTransaction.hash.toHex());
    }
}
