...
public class Transaction extends STObject {
    ...
    public SignedTransaction signFor(String account, String secret) {
        SignedTransaction signed = SignedTransaction.fromTx(this);
        signed.signFor(account, secret);
        return signed;
    }

    public SignedTransaction signFor(String account, IKeyPair keyPair) {
        SignedTransaction signed = SignedTransaction.fromTx(this);
        signed.signFor(account, keyPair);
        return signed;
    }
    ...
    public byte[] signingForData(AccountID account) {
